...
noise, founder-first — no hype, no "revolutionary"). Everything here is truthful
...
## 1. Boilerplate (reuse everywhere)

**One-liner (≤60 chars, for taglines):**
...
> summaries are on every plan, including a free tier — they're the point, not an
> upsell. Flat pricing ($0 free, $19/mo Pro), no dashboard to babysit, no "contact
> sales." One email a week. That's the whole product.
...
- Know what your competitors changed, in one weekly email _(54)_
- Low-noise competitor tracking, summarized weekly by AI _(54)_
- Track competitors without the dashboard — one email a week _(58)_
...
> teams, or bolt together page-change monitors that pinged me every time someone
...
> • The AI summaries are on every plan, including free — they're the point, not an upsell.
> • Flat pricing: $0 free, $19/mo Pro. No "contact sales."
...
**Gallery / GIF (you'll make these — recommended order):**
1. **Lead: a GIF of the teardown tool** — paste a competitor URL → the teardown
   renders (positioning, pricing tiers, what-to-watch). The interactive hook.
2. The weekly digest email (a clean shot of the plain-English summary).
3. The dashboard (this-week view with the "trivial edits filtered" stat).
4. Pricing (free + Pro, "AI on every plan").
...
> including free. More: /compare/visualping-alternative
...
**"Alternative to Kompyte" note:**
> A founder-sized alternative to enterprise competitive-intelligence and
> sales-enablement platforms like Kompyte. No demo, no seats, no dashboard to
> maintain — just add your competitors and get one plain-English digest a week on
> what changed. Free plan, flat Pro pricing. More: /compare/kompyte-alternative

_(Use the full URLs with the site base when the field wants an absolute link.)_

---

## 4. Directory blurbs

Use the **boilerplate** above — the one-liner, ~50-word, and ~100-word versions
cover almost every directory field. Category: "Competitive Intelligence" /
"Website Monitoring" / "Marketing" depending on the directory. Always include the
homepage link, and the teardown-tool link where a "free tool" field exists.

---

## 5. Indie Hackers post (disclosed founder story)

**Title:** I built a low-noise competitor tracker after drowning in page-change alerts

**Body:**
> I'm a solo founder, and keeping an eye on competitors kept costing me either too
> much money or too much attention.
>
> The enterprise competitive-intelligence tools are built for sales teams —
> battlecards, contracts, a platform to onboard. Overkill for one person. The
...
>
> A couple of decisions I'm opinionated about:
> • AI summaries are on every plan, including free (they're the product, not an upsell).
> • Flat pricing, no "contact sales."
>
...
**Golden rule: post as yourself, disclose you built it, lead with value. Never
astroturf, never pose as a neutral third party. Use each sub's weekly
...
**Comment template (only when genuinely on-topic — e.g. someone asks "how do you
...
repeatedly — write it fresh each time.)_

---

## 7. X / build-in-public (bonus, for Stage 3/4)
...
> stays short. Free tier + one flat paid plan; AI summaries on every plan. Free
> tool (no signup) that shows the idea: [teardown link]. Feedback welcome,
> especially on false positives/negatives in the filter.
