...
// /1 — the animated marketing landing variant. The homepage (/) is the finder
// page; this is a noindex alternative kept for reference / campaigns. The site's
// structured data lives on / (the indexed page), not here.
