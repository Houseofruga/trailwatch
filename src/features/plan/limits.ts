...
export const PLAN_PRICE: Record<Plan, string> = { free: "$0", paid: "$29/mo" };
...
export const PRO_MONTHLY_USD = 29;
export const PRO_ANNUAL_USD = 290;
...
/** The price line for the Pro card at a given billing period, e.g. "$29" + "/mo". */
